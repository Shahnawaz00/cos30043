        ...
        computed: {
          filteredUnits() {
            let filtered = this.units.filter(unit => {
              let codeMatch = this.unitCode === '' || unit.code.toLowerCase().includes(this.unitCode.toLowerCase());
              let descMatch = this.unitDesc === '' || unit.desc.toLowerCase().includes(this.unitDesc.toLowerCase());
              let typeMatch = this.unitType === 'all' || unit.type.toLowerCase() === this.unitType.toLowerCase();
